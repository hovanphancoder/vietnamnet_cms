...
return [
    // Page titles
    'Welcome Back - Sign In' => 'Chào mừng - Đăng nhập',
    ...
    // Instructions
    'Enter your email address and we will send you a password reset link' => 'Nhập địa chỉ email và chúng tôi sẽ gửi link đặt lại mật khẩu',
    ...
    'New Activation Code' => 'Mã kích hoạt mới',
