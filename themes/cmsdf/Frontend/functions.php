...
/**
 * Tạo URL cho trang author
 * 
 * @param string $username Username của author
 * @param string $lang Ngôn ngữ (mặc định là APP_LANG)
 * @return string URL đầy đủ của author
 */
if (!function_exists('link_author')) {
    function link_author($username, $lang = APP_LANG)
    {
        ...
        // Loại bỏ ký tự đặc biệt và chuẩn hóa username
...
/**
 * Tạo URL cho trang danh sách tác giả
 * 
 * @param string $lang Ngôn ngữ (mặc định là APP_LANG)
 * @return string URL đầy đủ của trang danh sách tác giả
 */
if (!function_exists('link_authors')) {
    function link_authors($lang = APP_LANG)
    {
        // Tạo URL với format chuẩn
        $url = "/tac-gia/";
