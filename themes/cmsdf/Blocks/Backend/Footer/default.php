...
<!-- <script src="/backend/assets/js/plugins/simplebar.min.js"></script>
<script src="/backend/assets/js/plugins/popper.min.js"></script> -->
<!-- <script src="/backend/assets/js/plugins/i18next.min.js"></script>
<script src="/backend/assets/js/plugins/i18nextHttpBackend.min.js"></script> -->
<!-- <script src="/backend/assets/js/icon/custom-font.js"></script>
<script src="/backend/assets/js/plugins/feather.min.js"></script>
<script src="/backend/assets/js/component.js"></script> -->
<!-- <script src="/backend/assets/js/theme.js"></script> -->
<!-- <script src="/backend/assets/js/multi-lang.js"></script> -->
