        ...
        <div class="bg-white py-8">
            <div class="max-w-7xl mx-auto">
                ...
                <div class="text-center mb-8">
                    <h1 class="text-2xl font-bold text-sky-600 uppercase">SEARCH RESULTS</h1>
                </div>
                ...
                <div class="space-y-4 sm:space-y-6">
                    ...
                    <div class="flex gap-4 pb-6 border-b border-gray-200 last:border-b-0 last:pb-0">
                        ...
                        <div class="flex-1 flex flex-col">
                                    <div class="text-xs sm:text-sm font-bold mb-2 text-sky-600 order-2 sm:order-1"><?= $category_name ?></div>
                            <h3 class="text-base font-bold text-gray-900 mb-3 leading-tight order-1 sm:order-2">
                                        <a href="<?= $post_url ?>" title="<?= htmlspecialchars($post['title']) ?>" class="hover:text-sky-600">
