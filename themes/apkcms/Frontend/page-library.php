...
if($subpage == 'themes') {
   get_template('library/themes');
    ...
    Render::asset('css', '/themes/cmsfullform/Frontend/assets/css/library_styles.css', ['area' => 'frontend', 'location' => 'head']);
    Render::asset('css', '/themes/cmsfullform/Frontend/assets/css/favorite-themes.css', ['area' => 'frontend', 'location' => 'head']);
    Render::asset('js', '/themes/cmsfullform/Frontend/assets/js/library.js', ['area' => 'frontend', 'location' => 'footer']);
