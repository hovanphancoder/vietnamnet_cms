...
<div class="w-full px-1 field floating-label mb-4 relative wrap-<?= $name ?> field_wysiwyg <?= $id ?>" style="<?= $visibility ? 'width:' . $width_value . $width_unit . ';' : 'display:none;' ?> ">
    <?php if ($label): ?>
    ...
    <div id="<?= $id ?>" class="form-label form-control border px-3 py-2 w-full rounded-md hover:outline-blue-400 focus:outline-blue-600 <?= $css_class ?>"></div>
